...
DEFINES += LF_LASERDEVAPI_BUILD_DLL
...
HEADERS += $$PTVAR_INC/interface/interfaceConfig.hpp
HEADERS += $$PTVAR_INC/interface/interface.hpp
SOURCES += $$PTVAR_SRC/interface/interface.cpp
