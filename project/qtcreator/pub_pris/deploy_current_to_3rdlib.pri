...
#公共库库路径
MY_PUBLIB_DIR = $$PTVAR_3rdLIB/$${LIB_NAME}/$${PROPALTFORM}/lib$$ARCHSUFFIX
#公共库头文件路径
MY_PUBINC_DIR = $$PTVAR_3rdLIB/$${LIB_NAME}/$${PROPALTFORM}/include/$${LIB_INC_NAME}
...
message(deploy lib to public library path $$PTVAR_3rdLIB/$${LIB_NAME} include is $${LIB_INC_NAME} )
