...
#QT += testlib  # fuck ! testlib会主动打开控制台，相当于配置了“CONFIG += console”！！！
QT += quickcontrols2
QT += positioning
QT += sql
QT += texttospeech
...
include (../pub_pris/build_asemanapp.pri)
...
#项目源代码
# 添加TaoQuick只能再这里IMPORT，在“RESOURCES +=”添加这个就会有错误
QML_IMPORT_PATH += $$PTVAR_SRC/qml/TaoQuick

SOURCES += $$PTVAR_SRC/qasemanapp/qasemanapp.cpp

HEADERS += $$PTVAR_INC/Utiles/QObjectThreadWapper.hpp

# excel导入导出
SOURCES += $$PTVAR_SRC/BasicExcel/BasicExcel.cpp
HEADERS += $$PTVAR_SRC/BasicExcel/BasicExcel.hpp
# 图片显示
SOURCES += $$PTVAR_SRC/ImageItem/ImageItem.cpp
HEADERS += $$PTVAR_SRC/ImageItem/ImageItem.h
SOURCES += $$PTVAR_SRC/PlusItem/PlusItem.cpp
HEADERS += $$PTVAR_SRC/PlusItem/PlusItem.h
# 视频流程抓取
SOURCES += $$PTVAR_SRC/MJPEGCapture/MJPEGCapture.cpp
HEADERS += $$PTVAR_SRC/MJPEGCapture/MJPEGCapture.h
# 系统控制
SOURCES += $$PTVAR_SRC/System/System.cpp
HEADERS += $$PTVAR_SRC/System/System.h
# 语音
SOURCES += $$PTVAR_SRC/Speeker/Speeker.cpp
HEADERS += $$PTVAR_SRC/Speeker/Speeker.h
# gps
SOURCES += $$PTVAR_SRC/LocationMonitor/LocationMonitor.cpp
HEADERS += $$PTVAR_SRC/LocationMonitor/LocationMonitor.h

RESOURCES += $$PTVAR_SRC/qml/qml.qrc
RESOURCES += $$PTVAR_SRC/qml/TaoQuick.qrc
RESOURCES += $$PTVAR_SRC/resource/resource.qrc
RC_FILE += $$PTVAR_SRC/resource/app.rc
